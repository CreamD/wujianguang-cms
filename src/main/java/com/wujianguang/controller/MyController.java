...
public class MyController {
	...
	//从session获取当前登录人的信息。用来指定发布人
		...
		article.setHot(0);//非热文章
		  ...
		  kafkaTemplate.send("1708D", "add="+JSON.toJSONString(article));
	...
	public String collect(Model model, HttpSession session) {
		...
		PageInfo<Collect> info = collectService.selects(collect, 1, 3);
		model.addAttribute("info", info);
	 ...
	 * @return: String
	 */
	@RequestMapping("article/delCollect")
	public String delCollect(Integer id) {
